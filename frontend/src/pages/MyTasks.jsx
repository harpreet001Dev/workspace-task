...
const MyTasks = () => {
  ...
  const loadMyTasks = async () => {
    ...
    try {
      ...
      console.log(error, "Unable to load my tasks.");
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="mb-6 rounded-2xl border border-slate-700/80 bg-[#0f1d2d] p-4 shadow-[0_20px_50px_rgba(15,23,42,0.65)]">
          <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <h1 className="mt-1 text-4xl font-bold tracking-tight text-white">My Tasks</h1>
            </div>
            ...
            {tasks.map((task) => (
              ...
              >
                ...
                <div className="mt-4 flex flex-wrap items-center gap-3 text-sm text-slate-300">
                  ...
                  <span className="rounded-full border border-slate-600 bg-slate-800/60 px-2 py-1">
                    Column: {task.columnId?.name || "Not set"}
                  </span>
                </div>
              </div>
            ))}
            ...
            <div className="space-y-4 text-slate-300">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <p className="text-base text-white">{selectedTask.columnId?.name || "Not set"}</p>
                </div>
